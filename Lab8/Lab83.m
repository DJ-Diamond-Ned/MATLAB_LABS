clear; clc; close all; % Очистка памяти, консоли и закрытие старых графиков
...
t_target = 9; % Точка, в которой нужно вычислить y (момент залпа)
...
% Пытаемся использовать функцию аппроксимации сплайном/полиномом с весами
try
...
%% БОНУС 1: НЕ ПОЛИНОМИАЛЬНАЯ ФУНКЦИЯ (ЭКСПОНЕНТА) - +0.5 балла
...
%% БОНУС 2: ПОЛИНОМ ЧЕБЫШЁВА - +0.5 балла
...
legend('Location', 'best'); % Легенда (пункт 7 критериев)
